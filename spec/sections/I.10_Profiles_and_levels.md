...
the constraint that  to,dpb( n ) >= Max( TotalPicSizeInMbs ÷ ( mvcdScaleFactor * MaxMBPS ), fR ), where
...
equal to mvcdScaleFactor * ( Max( PicSizeInMbs, fR * MaxMBPS ) + MaxMBPS * ( tr( 0 ) − tr,n( 0 ) ) ) ÷
...
( tr( 0 ) − tr,n( 0 ) ) ) ÷ SliceRate, where MaxMBPS and SliceRate are the values specified in Table A-1 and
...
mvcdScaleFactor * MaxMBPS * ( tr( n ) − tr( n − 1 ) ) ÷ SliceRate, where SliceRate is the value specified in
...
384 * mvcdScaleFactor * ( Max( PicSizeInMbs, fR * MaxMBPS ) + MaxMBPS * ( tr( 0 ) − tr,n( 0 ) ) ) ÷ MinCR
...
384 * mvcdScaleFactor * MaxMBPS * ( tr( n ) − tr( n − 1 ) ) ÷ MinCR, where MaxMBPS and MinCR are the
